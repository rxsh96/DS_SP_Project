...
public class FXML_superAdministradorController implements Initializable {
    ...
    private void accion_Productos(ActionEvent event) throws IOException{
        try {
            ...
            Logger.getLogger(FXML_superAdministradorController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    @FXML 
    private void accion_Usuarios(ActionEvent event) throws IOException{
        try {
            FXMLLoader loader = new FXMLLoader();
